my_api_key="2697e8b225msh953341e35efe1c7p1a2cc9jsna4383003d8eb"
$(function() {
  // Button will be disabled until we type anything inside the input field
  const source = document.getElementById('autoComplete');
  const inputHandler = function(e) {
    if(e.target.value==""){
      $('.mov-button').attr('disabled', true);
    }
    else{
  ...
  $('.movie-button').on('click',function(){
    vary_api_key = '2697e8b225msh953341e35efe1c7p1a2cc9jsna4383003d8eb';
    var title = $('.movie').val();
    if (title=="") {
...
function recommendcard(e){
  var my_api_key = '2697e8b225msh953341e35efe1c7p1a2cc9jsna4383003d8eb';
